...
OUTPUT_PATH = 'output'
MODEL_PATH = path.join(OUTPUT_PATH, 'resnet_tinyimagenet.hdf5')
FIG_PATH = path.join(OUTPUT_PATH, 'resnet_tinyimagenet.png')
JSON_PATH = path.join(OUTPUT_PATH, 'resnet_tinyimagenet.json')
